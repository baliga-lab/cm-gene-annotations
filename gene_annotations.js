...
(function (glob) {
    ...
    function drawAnnotation(paper, annot, annotY, params) {
        ...
        if (annot.condition !== null && annot.condition != "") {
    ...
    // Namespace to be initialized with the Raphael module
    // by dependency injection
    var annot = function(RaphaelModule) {
        Raphael = RaphaelModule;
    };
    annot.version = '1.0.0';
    ...
    glob.annot = annot;
    typeof module != 'undefined' && module.exports ? module.exports = annot : typeof define === "function" && define.amd ? define("annot", [], function () { return annot; }) : glob.annot = annot;
